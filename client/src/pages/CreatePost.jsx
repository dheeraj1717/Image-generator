...
function CreatePosts(){
  ...
  const handleSurpriseMe = () =>{
    ...
    return (
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[750px]">Create imaginative and visually stunning images through AI and share them with community</p>
      </div>
...
<FormField 
         ...
         <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-52 p-3 h-52 flex justify-center items-center">
          {form.photo?(
            <img 
            src={form.photo}
            alt={form.prompt}

...
//         </h1>
//         <p className="mt-2 text-[#666e75] text-[16px] max-w-[750px]">Browse through a collection of imaginative and visually stunning images generated by AI</p>
//       </div>
...
//           <>
//             {searchText && (
//               <h2 className="font-medium text-[#666e75] text-xl mb-3">Showing results for <span className="text-[#222328]"></span>{searchText}</h2>
//             )}
